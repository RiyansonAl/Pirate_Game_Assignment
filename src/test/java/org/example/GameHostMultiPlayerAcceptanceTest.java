...
class GameHostMultiPlayerAcceptanceTest {
    ...
    @Test
    @DisplayName("Acceptance Test Line 144")
    void acceptanceTestLine144(){
        System.out.println("A-TEST Line 144\n");
        ...
        try {
            ...
            //Player 1 card and Dice roll
            GameHost.FortuneCard player1Card = GameHost.FortuneCard.Gold;
            GameHost.Dice[] player1Dice = {GameHost.Dice.Sword, GameHost.Dice.Sword, GameHost.Dice.Sword,
                    GameHost.Dice.Sword, GameHost.Dice.Sword, GameHost.Dice.Sword,
                    GameHost.Dice.Skull, GameHost.Dice.Skull};
            ...
            //Player 2 card and Dice roll
            GameHost.FortuneCard player2Card = GameHost.FortuneCard.Sorceress;
            GameHost.Dice[] player2Dice = {GameHost.Dice.Skull, GameHost.Dice.Skull, GameHost.Dice.Skull,
                    GameHost.Dice.Skull, GameHost.Dice.Skull, GameHost.Dice.Skull,
                    GameHost.Dice.Skull, GameHost.Dice.Gold};

            GameHost.Dice[] player2Dice2 = {GameHost.Dice.Skull, GameHost.Dice.Skull, GameHost.Dice.Skull,
                    GameHost.Dice.Skull, GameHost.Dice.Skull, GameHost.Dice.Skull,
            ...
            //Player 2 goes to skull island
            if(player2.getIsSkullIsland() == true){
                msg = msg + "Player 2 goes to skull island \n";
                host.skullIsland(player2, player2Card, player2Dice, player2Dice2);
